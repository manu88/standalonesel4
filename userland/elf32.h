// from https://github.com/seL4/util_libs/blob/master/libelf/include/elf/elf32.h
/*
...
{
    return (const Elf32_Phdr *)file->elfFile + elf32_getHeader(file).e_phoff;
}

static inline const Elf32_Shdr *elf32_getSectionTable(const elf_t *elf)
{
    return (const Elf32_Shdr *) elf->elfFile + elf32_getHeader(elf).e_shoff;
}
