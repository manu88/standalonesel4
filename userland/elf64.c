// from https://github.com/seL4/util_libs/blob/master/libelf/src/elf64.c
/*
...
int elf64_checkFile(elf_t *elf)
{
    ...
    if (elf_check_magic((const char*) elf->elfFile) < 0) {
        return -1; /* not an ELF file */
    }

    Elf64_Ehdr const *header = (Elf64_Ehdr const *) elf->elfFile;
...
{
    const Elf64_Ehdr *header = (const Elf64_Ehdr *) elf->elfFile;
