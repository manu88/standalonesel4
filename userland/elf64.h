// from https://github.com/seL4/util_libs/blob/master/libelf/include/elf/elf64.h
/*
...
{
    return (const Elf64_Phdr *)file->elfFile + elf64_getHeader(file).e_phoff;
}

static inline const Elf64_Shdr *elf64_getSectionTable(const elf_t *file)
{
    return (const Elf64_Shdr *) file->elfFile + elf64_getHeader(file).e_shoff;
}
