// from https://github.com/seL4/util_libs/blob/master/libelf/src/elf32.c
/*
...
int elf32_checkFile(elf_t *elf)
{
    ...
    Elf32_Ehdr const *header = (Elf32_Ehdr const *) elf->elfFile;
...
{
    const Elf32_Ehdr *header = (const Elf32_Ehdr *) elf->elfFile;
