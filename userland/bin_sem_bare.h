// from
// https://github.com/seL4/seL4_libs/blob/master/libsel4sync/include/sync/bin_sem_bare.h
/*
...
static inline int sync_atomic_decrement_safe(volatile int *x, int *oldval,
  ...
  } while (!__atomic_compare_exchange_n(x, oldval, *oldval - 1, 1,
...
static inline int sync_bin_sem_bare_wait(seL4_CPtr notification,
                                         volatile int *value) {
  int oldval;
...
static inline int sync_bin_sem_bare_post(seL4_CPtr notification,
                                         volatile int *value) {
