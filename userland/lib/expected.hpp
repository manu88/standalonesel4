...
template <typename ValueType, typename ErrorType> struct Expected {
...
static inline Expected<ValueType, ErrorType>
success(ValueType val, ErrorType err = (ErrorType)0) {
  return Expected<ValueType, ErrorType>(val, err, true);
}

template <typename ValueType, typename ErrorType>
static inline Expected<ValueType, ErrorType>
unexpected(ErrorType err, ValueType val = (ValueType)0) {
